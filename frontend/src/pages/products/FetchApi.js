...
export const deleteProduct = async (pId) => {
  try {
    let res = await axios.post(`${apiURL}/product/delete-product`, { pId });
    return res.data;
  } catch (error) {
    console.log(error);
  }
...
export const productByDomaine = async (domaine) => {
  try {
    let res = await axios.post(`${apiURL}/product/domaine`, {
      domaine,
    });
    return res.data;
  } catch (error) {
...
export const productByPay = async (pay) => {
  try {
    let res = await axios.post(`${apiURL}/product/pay`, {
      pay,
    });
    return res.data;
  } catch (error) {
